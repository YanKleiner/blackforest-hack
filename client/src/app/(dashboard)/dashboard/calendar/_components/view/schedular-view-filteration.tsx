...
import AddEventModal from '@/app/(dashboard)/dashboard/calendar/_modals/add-event-modal';
import DailyView from '@/app/(dashboard)/dashboard/calendar/_components/view/day/daily-view';
import MonthView from '@/app/(dashboard)/dashboard/calendar/_components/view/month/month-view';
import WeeklyView from '@/app/(dashboard)/dashboard/calendar/_components/view/week/week-view';
import { useModal } from '@/app/(dashboard)/dashboard/calendar/_providers/modal-context';

import { ClassNames, CustomComponents, Views } from '@/types/index';
import { cn } from '@/lib/utils';

import CustomModal from '@/app/(dashboard)/dashboard/calendar/_components/custom-modal';
  ...
  return (
    <div className='flex w-full flex-col '>
      <div className='flex w-full'>
        <div className='dayly-weekly-monthly-selection relative w-full m-4'>
          <Tabs
            value={activeView}
