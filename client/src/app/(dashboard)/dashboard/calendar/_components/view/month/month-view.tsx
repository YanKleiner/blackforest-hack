...
import { useScheduler } from '@/app/(dashboard)/dashboard/calendar/_providers/schedular-provider';
...
import ShowMoreEventsModal from '@/app/(dashboard)/dashboard/calendar/_modals/show-more-events-modal';
import EventStyled from '@/app/(dashboard)/dashboard/calendar/_components/view/event-component/event-styled';
